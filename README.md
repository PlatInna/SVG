...
Необходимо написать простую библиотеку для вывода векторных изображений в формате SVG. Поскольку основное применение этой библиотеки в рамках курса — визуализация «Транспортного справочника», достаточно реализовать три типа объектов:
